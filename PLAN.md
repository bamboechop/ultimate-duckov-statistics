...
11. **M9 — Economy (`v0.9.0`, replacement candidate accepted; draft PR open)**
    ...
    - Current candidate evidence: the full live matrix and the prior `20fa8acdc873e331515d9155ed838b96cb820b7a` / `c4f020e29e0df213dd64ca88af97c61155d75d0a` deployments remain historical proof for exact Money/Cash deltas, failed-operation and hydration exclusion, production `AddAndMerge` neutrality, independent route/run/segment scopes, JSON/CSV agreement, and clean shutdown. A later review found four remaining boundaries: cross-scope economy mismatches could defeat a valid recovery backup; a completed Cash cost could suppress an unrelated coalesced drop; a Cash-returning sale could steal an unrelated same-amount Money correlation; and profile transitions exposed an undurable sequence-zero activation. Implementation `d5a3aba701d0d04aa9dd30a7ffa7601bc8f5ef8e` corrects all four and extends the installed-game contract probe for public `Cost.items`. Complete Debug/Release suites pass 624/624; the installed-game probe, frame-time analyzer, formatter, warning-free Core/native builds, package verifier, and independent extraction pass. The audited 256,866-byte ZIP is SHA-256 `a9ea1f9111c7cca785ea7fbd569a44eccd6f00b7abb82e8f86a024881c26389e`; after fresh approval it deployed transactionally with exact five-file readback, unchanged save/UDS-data trees, and no residue. Cold activation durably preserved sequence zero and unchanged totals; JSON/24-CSV export plus normal shutdown passed with byte-identical profiles, clean diagnostics, and no runtime residue. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
