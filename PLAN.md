...
- `v0.12.0` is the published M12 world-time and sleep statistics pre-release. M13 crafted-item statistics are merged into `main` through PR #14 as `a59ed777ed0f316bd7b7fcbd2b61aeacf8752990` and form the `v0.13.0` source baseline; M14 specifies the native UI overhaul for `v0.14.0`.
...
15. **M13 — Crafted-item statistics (`v0.13.0`, merged)**
