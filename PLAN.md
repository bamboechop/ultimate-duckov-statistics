...
- [ ] **Release preparation:** encounter history merged through [PR #25](https://github.com/bamboechop/ultimate-duckov-statistics/pull/25) on September 16, 2026 as `92ba6b6a438cc3dff7a91e0a8daa545434a3b8b1`. Prepare and verify the 1.1.1 release package, then complete publication checks. Merge, gameplay and publication remain user-controlled.
