...
6. **M5 — Damage, kills, deaths, melee, and headshots (`v0.5.0`, implementation and manual acceptance passed; final nested-checkpoint follow-up pending redeployment)**
