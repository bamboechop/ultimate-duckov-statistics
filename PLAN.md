...
- M14 preserves lossless weapon and equipment-slot associations as `v0.14.0`: accepted firing actions by weapon-ammunition pair plus equipped duration for proven character-slot state and nested equipped-item slot membership.
...
16. **M14 — Lossless weapon and equipment-slot associations (`v0.14.0`, implementation and user-controlled gameplay qualification complete)**
...
17. **M15 — Current economy holdings (`v0.15.0`, planned)**
