...
- M16 adds exact item-resource consumption for proven successful crafts and lossless output-resource associations as `v0.16.0`. Implementation, independent review, and user-controlled qualification are complete; [PR #17](https://github.com/bamboechop/ultimate-duckov-statistics/pull/17) merged as `4f24b026060e6dd883881c572411ec82b7812631`. M17 then applies the native UI overhaul to the stable M0-M16 data model as `v0.17.0`.
...
18. **M16 — Crafting-resource consumption statistics (`v0.16.0`, complete and merged)**
