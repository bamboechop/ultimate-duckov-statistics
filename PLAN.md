...
- Remaining capabilities each receive their own minor pre-release: M12 world-time and sleep statistics, M13 crafted-item statistics, and M14 the native UI overhaul are planned for `v0.12.0`, `v0.13.0`, and `v0.14.0` respectively.
...
14. **M12 — World-time and sleep statistics (`v0.12.0`, planned)**
