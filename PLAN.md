...
- M16 adds exact item-resource consumption for proven successful crafts and lossless output-resource associations as `v0.16.0`. Implementation, independent review, and user-controlled qualification are complete; [PR #17](https://github.com/bamboechop/ultimate-duckov-statistics/pull/17) merged as `4f24b026060e6dd883881c572411ec82b7812631`, and the [v0.16.0 GitHub pre-release](https://github.com/bamboechop/ultimate-duckov-statistics/releases/tag/v0.16.0) was published on 2026-08-30. M17 completes the retained-native UI overhaul plus the schema-17 Runs and schema-18 Equipment foundations as `v0.17.0`; implementation, independent review and re-review, and user-controlled qualification are complete, and [PR #18](https://github.com/bamboechop/ultimate-duckov-statistics/pull/18) merged as `b3c7e882e1090b4b302990051042f7c103f48653`. Tag and GitHub pre-release publication remain pending final release validation.
