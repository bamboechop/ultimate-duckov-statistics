...
- M15 adds independently available current Money and Cash holdings plus conditional liquid wealth as `v0.15.0`. Implementation, review, and user-controlled qualification are complete; [PR #16](https://github.com/bamboechop/ultimate-duckov-statistics/pull/16) merged as `c206d52894c04e15c2ab84dd1c0e62ed42750126`.
...
17. **M15 — Current economy holdings (`v0.15.0`, complete and merged)**
