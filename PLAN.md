...
12. **M10 — Lossless route-event association (`v0.10.0`, candidate qualified; draft PR open)**
...
16. **M14 — Release hardening and v1.0 RC audit (`v1.0.0-rc.1`, planned)**
    ...
    - Audit clean install and every supported schema upgrade through schema 12; primary/backup/temporary recovery; interruption and save-generation rotation; long multi-map and greater-than-100,000-event runs; capability degradation; duplicate setup/cleanup; UI/profile/JSON/CSV agreement; and the accepted M8.1 performance matrix on the final binary.
