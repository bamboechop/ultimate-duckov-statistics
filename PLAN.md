...
11. **M9 — Economy (`v0.9.0`, immutable candidate accepted; draft PR open)**
    ...
    - Current candidate evidence: the full live economy matrix proves exact Money/Cash deltas, semantic unknown retention, failed-operation exclusion, split/merge neutrality, hydration exclusion, export agreement, deferred base/shop durability, and residue-free shutdown. Scalable activation/sequence idempotency then passed 100,000-event and recovery stress, but its first deployed cold check exposed that the pre-event sequence-zero activation was normalized away during deferred cloning; totals remained exact and shutdown remained clean, while that build was rejected. Immutable correction commit `0b223e45bbafba8cbbe7f5d2213cd09588b5b870` preserves the registered sequence-zero state and passes the focused 7/7 persistence/candidate matrix, complete 606/606 Release suite, installed-game contract probe, frame-time analyzer, warning-free Core/native builds, formatting/source-safety gates, and exact five-file package validation. Its independently extracted 253,735-byte ZIP at SHA-256 `d2fa07eb39c2edb46bf0c42a2bf763798f2913751b75bb9742446ab4cff5b217` deployed transactionally after fresh approval with exact five-file readback and no save/profile change during promotion. The repeat cold base-only launch durably preserved nonempty activation `e21ea91e24a44df2b6794f47373e9637` at closed-through sequence zero in both primary and backup before any economy event; normal shutdown retained it with unchanged totals, byte-identical profiles, clean logs, and no runtime/deployment residue. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
