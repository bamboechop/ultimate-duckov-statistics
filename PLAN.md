...
- Planned post-M9 capabilities each receive their own minor pre-release: M10 lossless route association in `v0.10.0`, M11 combat ownership semantics in `v0.11.0`, M12 world-time and sleep statistics in `v0.12.0`, and M13 the native UI overhaul in `v0.13.0`.
...
12. **M10 — Lossless route-event association (`v0.10.0`, planned)**
