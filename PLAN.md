...
11. **M9 — Economy (`v0.9.0`, replacement candidate accepted; draft PR open)**
    ...
    - Current candidate evidence: the full live matrix and the previous `20fa8acdc873e331515d9155ed838b96cb820b7a` deployment prove exact Money/Cash deltas, failed-operation and hydration exclusion, production `AddAndMerge` neutrality, JSON/CSV agreement, deferred durability, and clean shutdown. A later review superseded that artifact as the final candidate because the unrelated M8 association ceiling suppressed exact segment-derived route-map economy, run overflow poisoned representable segment scopes, current-schema selection admitted noncomposing or duplicate currency evidence, recovery subtraction allowed reversed saturation, historical unresolved Cash rendered as zero, and README provenance was stale. Implementation `c4f020e29e0df213dd64ca88af97c61155d75d0a` corrects all six boundaries. Focused route/economy/persistence coverage passes 303/303 and complete Debug/Release suites pass 616/616; the installed-game probe, frame-time analyzer, formatter, source-safety gate, warning-free Core/native builds, package verifier, and independent extraction pass. The audited 253,369-byte ZIP is SHA-256 `7fb82e677ded97c127f900d1e2fde77af03fa66a3e6fb93ad99dfa38d83f19fe`. After fresh approval it deployed transactionally with byte-identical save/UDS data trees; cold base activation preserved sequence zero and unchanged totals, the Economy UI displayed acquired 0 plus secured/lost/unresolved Unsupported, and clean shutdown left byte-identical profiles with no residue or UDS error. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
