...
The active `feat/economy` branch is the unpublished v0.9.0 candidate. The current immutable implementation is `ce7fc2f968a371c05075afa2780f0fe6d4c27e45`: 629/629 Debug and Release tests pass together with the installed Duckov 2.3.30 / Steam 24013657 contract probe, frame-time analyzer, formatting/source-safety checks, warning-free Core/native builds, and exact-five-file package validation. In addition to preserving genuine lifetime degradation, zero-flow run evidence, and queued pre-interruption economy, lifetime publication treats the coordinator's exact not-initialized snapshot as a bootstrap placeholder rather than historical evidence; the placeholder persisted by the rejected prior build was safely replaced field-by-field by the first real native snapshot without changing counters or replay state. Its independently extracted 257,550-byte ZIP is SHA-256 `f022a01a72c6b7224ab098d8eef19384666aed599880baa4a0c97b0a3aa59f6d`. After exact-hash approval it deployed transactionally with byte-identical readback and unchanged save/UDS trees. Cold UI, JSON/24-CSV export, and clean shutdown all agree on restored Supported/Experimental capabilities, Money `+0/-1`, Cash `+58/-34`, sequence zero, and honestly Unsupported Cash terminal outcomes. The prior `ad62126d197978f9733b570f336305a520462b319ceffaaf6d358123caeccb2e` deployment remains rejected historical evidence only. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
