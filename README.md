...
The active `feat/economy` branch is the unpublished v0.9.0 candidate. The current immutable implementation is `c4f020e29e0df213dd64ca88af97c61155d75d0a`: 616/616 Debug and Release tests pass together with the installed Duckov 2.3.30 / Steam 24013657 contract probe, frame-time analyzer, formatting/source-safety checks, warning-free Core/native builds, and exact-five-file package validation. It preserves route-map economy after the independent 2,048-row association ceiling, keeps run and segment arithmetic limits independent, rejects noncomposing/duplicate persisted currency evidence and reversed saturation watermarks before backup selection, and renders every unavailable pre-M9 Cash outcome—including unresolved—as unsupported. Its independently extracted 253,369-byte ZIP is SHA-256 `7fb82e677ded97c127f900d1e2fde77af03fa66a3e6fb93ad99dfa38d83f19fe`. Fresh exact-hash deployment/readback, cold base activation, Economy UI verification, and clean shutdown pass without changing Money/Cash totals or leaving persistence/deployment residue. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
