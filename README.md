...
Each economy aggregate retains at most 2,048 exact event identities. At that bound it keeps all accepted totals and identities, marks `deduplication_saturated`, and disables further capture for that aggregate instead of evicting evidence and risking a later replay double count. Cash terminal resolution for already-recorded acquisitions remains independently available.
