...
The active `feat/economy` branch is the unpublished v0.9.0 candidate. The current local implementation is `5e27359357f4433de11be329cd2cc7a785b2687c`: 631/631 Release tests pass together with focused M9/UI coverage, the installed Duckov 2.3.30 / Steam 24013657 contract probe, frame-time analyzer, formatting/source-safety checks, and warning-free Core/native builds. Compact and detailed Economy projections now compare persisted scope availability with the separate live adapter snapshot for Money/Cash totals and every Cash raid outcome, retaining `current capture unavailable` only for a currently disabled adapter and using scope-aware wording after a successful restart. No package, deployment, gameplay, CI, or publication evidence exists for this local correction yet. The installed predecessor remains `8aaaacd9533182feb5ffaa8ec3d2889773420f41`; its approved ZIP, cold compact Overview/Runs validation, JSON/24-CSV export, and clean shutdown remain valid historical evidence but are superseded as final-candidate evidence. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged at predecessor head `d4b4dc75a3ab4d9d2859511d821bfdf64d128474`.
