...
The active `feat/economy` branch is the unpublished v0.9.0 candidate. The current immutable implementation is `19c80465f3b420e8454e085bd55a02019b0e5588`: 628/628 Debug and Release tests pass together with the installed Duckov 2.3.30 / Steam 24013657 contract probe, frame-time analyzer, formatting/source-safety checks, warning-free Core/native builds, and exact-five-file package validation. In addition to the earlier route, arithmetic, recovery, Cash-operation, and activation corrections, lifetime capability degradation now survives restart, zero-flow degraded runs retain their evidence through later aggregate fan-out, and the different-native-raid fallback drains queued economy before interrupting the old run. Its independently extracted 257,280-byte ZIP is SHA-256 `ad62126d197978f9733b570f336305a520462b319ceffaaf6d358123caeccb2e`; it has not been deployed and requires fresh exact-hash approval. The currently installed `a9ea1f9111c7cca785ea7fbd569a44eccd6f00b7abb82e8f86a024881c26389e` package remains historical accepted evidence with completed cold activation, JSON/24-CSV export, and clean shutdown gates. [Draft PR #10](https://github.com/bamboechop/ultimate-duckov-statistics/pull/10) remains open and unmerged.
