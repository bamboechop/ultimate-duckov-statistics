...
public sealed class EquipmentCompositionTests
{
    ...
    [Fact]
    public void CapturesExactRootsNestedEmptyAndUnknownSlotWithoutJournaling()
    {
    ...
    [Fact]
    public void UnavailableIdentityNeverRegistersReadableSubset()
    {
    ...
    [Fact]
    public void NamesEnrichWithoutChangingIdentityOrTime()
    {
    ...
    [Fact]
    public void IncompleteNestedEvidenceEnrichesButContradictionFailsClosed()
    {
    ...
    [Fact]
    public void RootConflictNeverPicksLastDefinition()
    {
    ...
    [Fact]
    public void SetsRetainOnlyActiveMembersAndStateRetainsDirectToteAndCopies()
    {
        var s = Snapshot();
        s.Totems.Add(new TotemSnapshot
        {
            ...
            DirectSlotId = "duckov:slot:totem-b",
            ActivationState = TotemActivationState.ProvenInactive
        });
        for (var i = 0; i < 2; i++) s.Totems.Add(new TotemSnapshot
        {
            ItemId = "duckov:totem:2",
    ...
    [Fact]
    public void MergeAndCloneRetainDefinitionsAndIndependentCounters()
    {
    ...
    [Fact]
    public void NativeRequiredCategoryProvesEmptySlotWithoutLocalizedNameGuess()
    {
    ...
    [Fact]
    public void TypedDurationOverflowIsRejectedBeforeMutation()
    {
    ...
    [Fact]
    public void CorruptDefinitionAndTypedIdentityAreRejected()
    {
        var a = Observed(); a.Composition.Loadouts.Values.Single().Items[0].ItemId = "tampered";
        Assert.Throws<ArgumentException>(() => EquipmentStatisticsReducer.ValidateRecoveryCandidate(a));
        a = Observed(); a.Composition.TotemStates.Values.Single().Totem.DirectSlotId = "tampered";
        Assert.Throws<ArgumentException>(() => EquipmentStatisticsReducer.ValidateRecoveryCandidate(a));
    }
    [Fact]
    public void MissingConflictMarkerCannotSilentlyReleaseConflictingHistory()
    {
