...
| Tracking systems | Exact current capability IDs, including successful throwable releases. Groups expose independent metrics and nested adapter ID, version, state and detail. Missing or conflicting supported-contract evidence cannot become Working. Baseline-impossible metrics stay unavailable in their group and limitations without falsely disabling supported siblings. |
