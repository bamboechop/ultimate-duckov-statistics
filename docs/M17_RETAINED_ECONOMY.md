...
| Of which proven acquired | `CashRaidOutcomes.Acquired`, displayed beneath Raid context in the inflow column only | Strict subordinate placement, no net/secured/profit claim, and missing context evidence remains unavailable |
