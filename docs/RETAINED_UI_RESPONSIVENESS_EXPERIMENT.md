...
- Loading/refreshing text stays hidden for the first 250 ms of pending work. Fast transitions show their content directly; cached content stays visible during refreshes. Selecting another tab or reopening starts a fresh delay, and completion hides the message immediately.
