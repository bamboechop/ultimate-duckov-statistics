...
Corrected package, deployment, reload-equivalent identity, forced-interruption recovery, unavailable-outcome presentation, export agreement, and clean restart/shutdown gates pass. Source push, draft-PR update, and final remote CI remain required before the draft PR can return to independent review.
