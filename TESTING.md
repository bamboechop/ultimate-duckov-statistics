...
| Five-file package audit | Passed from committed P1 head 2026-08-10 | Exact inventory and no forbidden DLL; both packaged DLLs embed commit `f775fa23910653c06d651f616d3c91346f2fbb1e`. Independent ZIP extraction is byte-identical to the package. The earlier gameplay-tested deployment remains unchanged because manual gameplay/deployment was not repeated as requested |
...
| Source, draft PR, CI, ZIP, and checksum | P1 source/artifact passed; delivery pending | Fix commit `f775fa2` and committed-head ZIP/checksum are verified; push and final-head CI remain |
