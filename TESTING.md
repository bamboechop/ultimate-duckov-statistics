...
- Only top-level `Item_ToteBag` items in the exact main duck's public ordinary `CharacterItem.Inventory` are Tote containers. Their attached public inventories prove nested Totem presence. A Tote Bag is not a character-slot item. Presence does not prove which individual effects or modifiers opted into inventory activation, so tote-carried activation is `Unknown`, the tote-activation capability is `DisabledIncompatible`, and tote contents are excluded from active-totem-set duration.
...
The committed final-automation implementation `6a851f23d8aa483f14140454de876d8efbf1b10f` passes the complete release pipeline: 246/246 Release tests; installed Duckov/Harmony contract probe; native Release build with zero warnings/errors; formatter verification for all 30 branch-changed C# files; `git diff --check`; tracked-source safety; package validation; exact checksum-sidecar verification; and independent extraction. It adds independent direct-slot occupancy and slotted-weapon duration aggregates, readable recent-transition identities, and a Core-owned canonical identity builder whose tests prove order stability, display-name independence, duplicate-totem multiplicity, direct inactive presence, and active-set truth boundaries.

`UltimateDuckovStatistics-v0.6.0.zip` is 167,950 bytes at SHA-256 `58c9b5b41c36180e2714295a7084e9981b11ab146023a417569b62b038f516df`; its lowercase two-space sidecar is exact. Independent extraction at `artifacts/audit-v060-6a851f2` contains exactly the five permitted folder-rooted files, passes package verification, contains no game/Harmony dependency, and is byte-identical to the package root. Candidate package hashes are `d47363e7ada07d08b48b35fa3dd0f7d6c2480bcd5068235ba05a520684dd2fed` (`info.ini`), `4eecd08254d43b5e69bc102f07f6c6db4e5418351196a06365e5d75876638e2f` (`INSTALL.md`), `0f7558f2469ad0901074f6c380ada1ed91861d55adf905267bc70b26cd2e3ccc` (`LICENSE`), `afbdef2598d1ea3ece5488de828d30eb5e52bfb26152c58e46e104f82c15431d` (Core DLL), and `c2f458a692259b356fd27acfbf3915f9ce4ce393ad48439ed1a66c5df7d05eee` (native DLL). Both DLLs report file version `0.6.0.0` and product version `0.6.0+6a851f23d8aa483f14140454de876d8efbf1b10f`. No game installation, Duckov save, or UDS profile was written during these automated/package gates.
...
Every available technical manual-acceptance gate passes. Completion remains pending only explicit user acceptance of this evidence and the stated unavailable live cases. No merge, tag, GitHub release, ready-for-review transition, or Workshop upload is authorized by this protocol.
