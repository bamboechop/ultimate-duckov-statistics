...
| Source, draft PR, CI, ZIP, and checksum | P2 source/artifact passed; delivery pending | Fix commit `c98b874` and committed-head ZIP/checksum are verified; push and final-head CI remain |
