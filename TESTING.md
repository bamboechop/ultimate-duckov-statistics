...
Manual acceptance remains pending the lower Equipment/recurring panel readback, clean restart/no-duplicate verification, final normal-shutdown residue check, and explicit user acceptance. No merge, tag, GitHub release, ready-for-review transition, or Workshop upload is authorized by this protocol.
