...
- Replacement committed-head package, deployment/readback, focused historical-run export verification, source push, draft-PR update, and final CI remain required. The prior `50c9b06ba03fb161cc68ffef8f81f05c4732d6b963961c6eda413f7a5766933f` ZIP and gameplay deployment are superseded by these source corrections.
