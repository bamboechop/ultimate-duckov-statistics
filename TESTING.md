...
- Replacement package/deployment/readback and focused historical-run UI/export verification pass. Source push, draft-PR update, and final CI remain required before independent re-review.
