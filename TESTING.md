...
| Source, draft PR, CI, ZIP, and checksum | Passed after P1 follow-up 2026-08-10 | Fix commit `f775fa2` and committed-head ZIP/checksum are verified; draft PR #2 remained open, draft, and unmerged at pushed head `c03e27e`; both duplicate `core` and `source-safety` CI runs passed |
