...
- This is a persisted-data composition correction and does not change the native firing hook or accepted gameplay semantics, so the already-accepted gameplay matrix remains valid and no additional user gameplay is required. Committed-head package generation, deployment readback, source push, draft-PR synchronization, and final CI remain pending. The prior `f2bdb3c98786d7a8ba6d56746242c0aa16611391058305388f27881dcf1507a1` ZIP and deployment are superseded.
