...
| --- | --- | --- |
| Automated Release suite | Passed after P1 follow-up 2026-08-09 | 103 tests; full M0/M1 regression plus immediate/delayed healing, full/partial overheal, interleaving, unowned same-ID refresh invalidation, exact four-category Harmony patch-set validation, required-callback removal, production reflective patcher behavior, restart, migration/recovery, delayed-healing group repair, capability, export, and forbidden-package cases |
...
| Five-file package audit | Passed on P1 working tree 2026-08-09 | Exact inventory and no forbidden DLL; committed-head hashes and ZIP byte comparison remain pending. The earlier gameplay-tested deployment remains unchanged because manual gameplay/deployment was not repeated as requested |
...
| Source, draft PR, CI, ZIP, and checksum | Reopened by P1 follow-up | Fix commit, committed-head ZIP/checksum regeneration, push, and final-head CI remain |
