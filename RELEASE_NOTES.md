...
- The third corrective implementation and its `f2bdb3c98786d7a8ba6d56746242c0aa16611391058305388f27881dcf1507a1` ZIP passed package, deployment, and CI gates, but a later review found that normalization could repair malformed lifetime data into an empty-looking shape and wrongly enable current-capability fallback. Fourth corrective implementation `d2836feb27706373c3d4a618974cc6f112fb1163` persists invalid-repair provenance and passes exact migration/reopen/UI/export regressions. Its committed-head ZIP is 110,946 bytes at SHA-256 `147ecde3342a0a78109a59c65ce7bc6c73680f4bdadddd515c327f07151eea33`; independent extraction and the approved transactional deployment contain exactly the five permitted files and match the package root byte-for-byte. Both DLLs have file version `0.4.0.0` and product version `0.4.0+d2836feb27706373c3d4a618974cc6f112fb1163`; deployment residue is zero. Source push, draft-PR synchronization, and both remote CI jobs passed at evidence head `c0583e5ec55ce3e7ab2256ed4b1aff4fe35e6a21`; the PR stays draft.
