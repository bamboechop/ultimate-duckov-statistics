...
The first scalable-idempotency correction passed the complete 605-test Release suite, 100,000-event stress, installed-game probe, warning-free builds, exact package/extraction audit, and approved byte-exact deployment as implementation commit `ea49808897c018bfbe437859475acb2c6240fb37` / ZIP SHA-256 `2ef0899013319b91bd8771b18e805fa780c82300726f7ba34a495d4a90b4b1b7`. Its cold base-only activation exposed that a newly registered activation at closed-through sequence zero was incorrectly normalized as malformed during the first deferred clone, clearing the activation and marking repair before any transaction. Totals and prior evidence remained exact, and normal shutdown was clean, but that package and deployment are superseded. Immutable implementation commit `0b223e45bbafba8cbbe7f5d2213cd09588b5b870` treats the registered sequence-zero cursor as valid, retains negative or malformed activation metadata rejection, and passes the focused 7/7 persistence/candidate matrix, complete 606/606 Release suite, installed-game probe, frame-time analyzer, warning-free Core/native builds, formatting/source-safety gates, and exact package validation. Its independently extracted 253,735-byte ZIP is SHA-256 `d2fa07eb39c2edb46bf0c42a2bf763798f2913751b75bb9742446ab4cff5b217`; both DLLs report product version `0.9.0+0b223e45bbafba8cbbe7f5d2213cd09588b5b870`. Freshly approved redeployment/readback, repeat cold persistence, final-head documentation, and updated draft-PR CI are pending. The paragraph below records the still-earlier 2,048-hard-stop candidate and is retained only as historical evidence.
