...
- Fourth corrective implementation `d2836feb27706373c3d4a618974cc6f112fb1163` and its `147ecde3342a0a78109a59c65ce7bc6c73680f4bdadddd515c327f07151eea33` ZIP passed package, deployment, and CI gates, but a later review found that destructive removal of null or blank-key weapon/ammunition rows did not set the repair marker. The fifth correction marks both collections and all serializer-representable invalid forms, with exact normalization, repository, backup, rotation, UI, JSON, CSV, pristine-fallback, idempotence, and non-mutation regressions. Its committed-head package, deployment readback, source push, draft-PR synchronization, and remote CI remain pending; the PR stays draft.
