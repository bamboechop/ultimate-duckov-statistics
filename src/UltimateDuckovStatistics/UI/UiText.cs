...
internal static class UiText
{
    ...
    private static readonly Dictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ui.menu_access_limited"] = "Statistics tracking remains healthy. Use the configured hotkey outside raids and inspect Recent issues for the unavailable menu path.",
