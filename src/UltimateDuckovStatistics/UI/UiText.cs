...
internal static class UiText
{
    ...
    private static readonly Dictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ui.combat_weapon_accuracy_basis"] = "Accuracy: this weapon's ranged hits per firing action, across all ammunition. Multiple projectiles can exceed 100%.",
            ["ui.combat_other_player_kills"] = "Other kills by you",
            ["ui.combat_effect_kills"] = "Effects / damage-over-time kills",
