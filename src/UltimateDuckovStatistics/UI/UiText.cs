...
internal static class UiText
{
    ...
    private static readonly Dictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ui.encounters_death"] = "Your death",
            ["ui.encounters_other"] = "Other final blow",
            ["ui.encounters_no_damage"] = "No damage recorded",
            ["ui.encounters_effect_damage"] = "Effect damage",
            ["ui.encounters_melee_damage"] = "Melee damage",
            ["ui.encounters_damage_amount"] = "{0} damage",
            ["ui.encounters_kill_title"] = "{0} killed",
            ["ui.encounters_death_title"] = "Died to {0}",
            ["ui.encounters_other_title"] = "{0} died",
            ["ui.encounters_player"] = "Player",
            ["ui.encounters_enemy"] = "Enemy",
            ["ui.encounters_with"] = "with",
            ["ui.encounters_from"] = "from",
            ["ui.encounters_dealt_amount"] = "{0} damage dealt",
            ["ui.encounters_received_amount"] = "{0} damage received",
            ["ui.encounters_hit_one"] = "in {0} hit",
            ["ui.encounters_hit_count"] = "in {0} hits",
            ["ui.encounters_headshot_one"] = "{0} headshot",
            ["ui.encounters_headshot_count"] = "{0} headshots",
            ["ui.encounters_dealt"] = "Damage dealt",
            ["ui.encounters_received"] = "Damage received",
            ["ui.encounters_inventory"] = "Enemy inventory & loot",
            ["ui.encounters_position_unavailable"] = "Encounter positions unavailable",
            ["ui.encounters_uninspected"] = "No inspected contents recorded",
            ["ui.encounters_loot_legend"] = "Highlighted: items kept from this enemy.",
            ["ui.encounters_loading"] = "Loading encounter history…",
            ["ui.encounters_read_failed"] = "Encounter history could not be loaded. Reopen Map & Kills to retry.",
            ["ui.encounters_no_history"] = "No encounter recording for this run. New runs are recorded automatically.",
            ["ui.encounters_capture_stopped"] = "Encounter recording stopped. This run's encounter history is incomplete.",
            ["ui.encounters_capture_incomplete"] = "Some encounter data could not be recorded.",
            ["ui.encounters_no_recorded_kills"] = "No recorded kills or deaths are available.",
            ["ui.encounters_no_kills"] = "No fatal encounters recorded for this run",
            ["ui.encounters_no_signal"] = "SATELLITE LINK LOST",
            ["ui.encounters_no_signal_body"] = "No eyes in the sky. Your combat log made it through.",
            ["ui.about"] = "About",
            ...
            ["ui.about_translation"] = "Want to help translate UDS? Leave a comment on the Steam Workshop page and mention the language you could help with.",
            ...
            ["ui.export"] = "Export ZIP",
            ["ui.restore"] = "RESTORE STATISTICS",
            ["ui.restore_title"] = "Restore from an export",
            ["ui.restore_confirm"] = "Replace UDS statistics",
            ["ui.restore_previous"] = "Previous export",
            ["ui.restore_next"] = "Next export",
            ["ui.restore_copied_path"] = "Use copied file path",
            ["ui.restore_select"] = "Choose a saved export, or copy the path of a JSON or ZIP export in File Explorer and use it here.",
            ["ui.restore_reading"] = "Reading and validating export…",
            ["ui.restore_no_exports"] = "No saved export found. You can use a copied file path.",
            ["ui.restore_preview"] = "Save slot {0}\nExported: {1}\nRecorded runs: {2}\nRaid distance: {3:N2} m",
            ["ui.restore_invalid"] = "This export cannot be restored:",
            ["ui.restore_warning"] = "This replaces all UDS statistics for {0} with the selected export. Statistics recorded since that export will be replaced. The previous UDS profile is archived. Your Duckov save is unchanged.",
            ["ui.restore_running"] = "Restoring statistics…",
            ["ui.restore_success"] = "Statistics restored. Previous UDS profile archived.",
